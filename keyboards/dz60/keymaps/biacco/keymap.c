...
[BASE] = LAYOUT_biacco(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_JYEN, SFT_T(KC_RO),
...
[BIAC] = LAYOUT_biacco(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_W,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SLSH, KC_JYEN, SFT_T(KC_RO),
  KC_LCTL, KC_LGUI, _______,          RCTL_T(KC_SPC),   KC_BSPC, LT(BMETA, KC_ENT),KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, RESET
),
